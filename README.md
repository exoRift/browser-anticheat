...
## Getting started
Upon botting the program, you'll be greeting with a menu in which you will choose your hosting method. There are two choices: classic and tunnel
### Classic Mode
...
In the main menu, you can shut down the application, change the server password, or configured anticheat settings such as
